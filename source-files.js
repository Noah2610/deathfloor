...
sourcesIndex["amethyst_animation"] = {"name":"","dirs":[{"name":"skinning","files":["mod.rs","resources.rs","systems.rs"]},{"name":"systems","files":["control.rs","mod.rs","sampling.rs"]}],"files":["bundle.rs","lib.rs","material.rs","prefab.rs","resources.rs","sprite.rs","transform.rs","ui_transform.rs","util.rs"]};
...
sourcesIndex["amethyst_input"] = {"name":"","files":["axis.rs","bindings.rs","bundle.rs","button.rs","controller.rs","event.rs","input_handler.rs","lib.rs","mouse.rs","scroll_direction.rs","system.rs","util.rs"]};
...
sourcesIndex["climer"] = {"name":"","dirs":[{"name":"time","dirs":[{"name":"builder","files":["mod.rs"]}],"files":["mod.rs","time_conversion.rs"]},{"name":"timer","files":["builder.rs","mod.rs","output.rs","state.rs"]}],"files":["error.rs","helpers.rs","lib.rs","macros.rs","settings.rs"]};
sourcesIndex["climer_derive"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["deathfloor"] = {"name":"","dirs":[{"name":"collision_tag","files":["collision_label.rs","collision_tag.rs","mod.rs"]},{"name":"components","dirs":[{"name":"enemy","files":["enemy_type.rs","mod.rs"]},{"name":"event_listener","dirs":[{"name":"actions","files":["delay.rs","echo.rs","group.rs","insert_components.rs","mod.rs","move_action.rs","random.rs","repeat_delay.rs"]}],"files":["action_trigger.rs","action_type_trigger.rs","event_type.rs","events_register.rs","mod.rs"]},{"name":"movable","files":["mod.rs","move_action.rs"]}],"files":["bullet.rs","jumper.rs","jumppad.rs","jumppad_affected.rs","max_movement_velocity.rs","mod.rs","physics_data.rs","player.rs","shooter.rs","walker.rs","wall_jumper.rs","wall_slider.rs"]},{"name":"input","files":["ingame_bindings.rs","mod.rs","paused_bindings.rs"]},{"name":"map_loader","dirs":[{"name":"map_data","files":["mod.rs","propful.rs"]},{"name":"objects","files":["build_camera.rs","build_enemy.rs","build_player.rs","helpers.rs","mod.rs","object_type.rs"]},{"name":"tiles","files":["helpers.rs","mod.rs","tile_type.rs"]}],"files":["helpers.rs","mod.rs"]},{"name":"resources","files":["bullet_creator.rs","mod.rs"]},{"name":"settings","files":["camera_settings.rs","enemies_settings.rs","general_settings.rs","hitbox_config.rs","mod.rs","player_settings.rs","tiles_settings.rs"]},{"name":"states","files":["ingame.rs","load_ingame.rs","mod.rs","paused.rs","startup.rs"]},{"name":"systems","dirs":[{"name":"event_handlers","dirs":[{"name":"actions","files":["delay.rs","echo.rs","group.rs","insert_components.rs","mod.rs","move_action.rs","random.rs","repeat_delay.rs"]},{"name":"events","files":["interval.rs","mod.rs","on_collision.rs","on_spawn.rs"]}],"files":["bundle.rs","mod.rs","trigger_actions_from_action_types.rs"]}],"files":["bullet_hit.rs","control_player.rs","control_player_jump.rs","control_player_shoot.rs","create_bullets.rs","delete_bullets.rs","handle_animations.rs","handle_jumppad_affected.rs","handle_movables.rs","handle_scales.rs","handle_walkers.rs","mod.rs"]}],"files":["animation_key.rs","dispatcher_id.rs","helpers.rs","init.rs","main.rs"]};
sourcesIndex["deathframe"] = {"name":"","dirs":[{"name":"bundles","files":["animation_bundle.rs","mod.rs","physics_bundle.rs"]}],"files":["components.rs","lib.rs","resources.rs","systems.rs"]};
sourcesIndex["deathframe_animation"] = {"name":"","dirs":[{"name":"components","dirs":[{"name":"animation","files":["mod.rs"]},{"name":"animations_container","files":["animations_container_builder.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"data","files":["animation_frame.rs","animation_frames_iter.rs","animation_type_wrapper.rs","mod.rs"]},{"name":"systems","files":["mod.rs","play_animations.rs","switch_animations.rs"]}],"files":["lib.rs"]};
sourcesIndex["deathframe_core"] = {"name":"","dirs":[{"name":"components","files":["confined.rs","follow.rs","loadable.rs","loaded.rs","loader.rs","mod.rs","scale_once.rs","size.rs"]},{"name":"custom_game_data","files":["builder.rs","data.rs","mod.rs"]},{"name":"geo","dirs":[{"name":"axis","files":["by_axis.rs","mod.rs"]}],"files":["mod.rs","rect.rs"]},{"name":"resources","files":["entity_component_inserter.rs","input_manager.rs","mod.rs","sprite_sheet_handles.rs"]},{"name":"systems","files":["confine_entities.rs","entity_loader.rs","follow.rs","input_manager.rs","mod.rs","scale_sprites.rs"]}],"files":["lib.rs","menu.rs"]};
sourcesIndex["deathframe_physics"] = {"name":"","dirs":[{"name":"collision","dirs":[{"name":"data","files":["mod.rs","side.rs","state.rs"]}],"files":["collision_check.rs","grid.rs","mod.rs","rect.rs","tag.rs"]},{"name":"components","dirs":[{"name":"gravity","files":["mod.rs"]},{"name":"velocity","files":["mod.rs"]}],"files":["base_friction.rs","collidable.rs","collider.rs","hitbox.rs","mod.rs","solid.rs"]},{"name":"query","files":["exp.rs","filter_query.rs","find_query.rs","mod.rs","query_helpers.rs"]},{"name":"systems","files":["apply_base_friction.rs","apply_gravity.rs","mod.rs","move_entities.rs","update_collisions.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["lyon_path"] = {"name":"","files":["builder.rs","events.rs","iterator.rs","lib.rs","path.rs","path_state.rs"]};
